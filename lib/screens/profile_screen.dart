...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final heroHeight =
        screenWidth *
        0.4; // 👈 Responsive hero height (or use fixed like 200.0)
    ...
    return Scaffold(
      appBar: PreferredSize(
        preferredSize: Size.fromHeight(
          heroHeight + avatarOverlap,
        ), // 👈 Total height including overlap
        child: Stack(
          ...
          children: [
            ...
            Positioned(
              ...
              left: 0,
              right: 0,
              child: Center(child: _buildAvatar(context, user)),
            ),
          ],
        ),
      ),
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              _InfoTile(
                icon: Icons.login,
                title: user.appMetadata['provider'] as String? ?? 'email',
                subtitle: user.email ?? '—',
              ),
            ],
          ),
